             ...
             <div class="card card-login card-white">
               ...
               <div class="card-body">
                 <div class="input-group">
                   ...
                   <input type="text" class="form-control" name="admin_username" placeholder="User Name">
                 </div>
                 <div class="input-group">
                   <div class="input-group-prepend">
                     <div class="input-group-text">
               ...
               <div class="card-footer">
                 <button name="login_admin" class="btn btn-primary btn-lg btn-block mb-3">Get Started</button>
                 <div class="pull-left">
                   <h6>
